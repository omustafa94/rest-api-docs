We at Earthport provide our [REST](https://en.wikipedia.org/wiki/Representational_state_transfer)ful API to all our clients, which has predictable resource-oriented URLs, and uses HTTP response codes to indicate API errors. 
