We at Earthport provide all our clients with our [REST](https://en.wikipedia.org/wiki/Representational_state_transfer)ful API, which has predictable resource-oriented URLs, and uses HTTP response codes to indicate API errors. 
