We at Earthport provide all our new clients with our [REST](https://en.wikipedia.org/wiki/Representational_state_transfer)ful API service - which has predictable resource-oriented URLs, and uses HTTP response codes to indicate API errors. 
