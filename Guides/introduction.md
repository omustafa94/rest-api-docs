We at Earthport provide [REST](https://en.wikipedia.org/wiki/Representational_state_transfer)ful APIs. Our API has predictable resource-oriented URLs, and uses HTTP response codes to indicate API errors. 
